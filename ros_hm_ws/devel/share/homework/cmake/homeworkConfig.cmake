...
if("TRUE" STREQUAL "TRUE")
  set(homework_SOURCE_PREFIX /home/lyq/ros_hm_ws/src/homework)
  set(homework_DEVEL_PREFIX /home/lyq/ros_hm_ws/devel)
  set(homework_INSTALL_PREFIX "")
  set(homework_PREFIX ${homework_DEVEL_PREFIX})
else()
  set(homework_SOURCE_PREFIX "")
  set(homework_DEVEL_PREFIX "")
  set(homework_INSTALL_PREFIX /home/lyq/ros_hm_ws/install)
...
if(NOT "/home/lyq/ros_hm_ws/devel/include " STREQUAL " ")
  set(homework_INCLUDE_DIRS "")
  set(_include_dirs "/home/lyq/ros_hm_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'homework' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lyq/ros_hm_ws/src/homework/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lyq/ros_hm_ws/devel/lib;/home/lyq/ros_hm_ws/devel/lib;/opt/ros/noetic/lib)
...
set(homework_EXPORTED_TARGETS "homework_generate_messages_cpp;homework_generate_messages_eus;homework_generate_messages_lisp;homework_generate_messages_nodejs;homework_generate_messages_py")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(homework_EXPORTED_TARGETS ${${homework_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "homework-msg-extras.cmake")
